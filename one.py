...
for epoch in range(1, 11):
    train_load_time, train_push_time, train_time, total_train_time = train(model, device, train_loader, optimizer, criterion, epoch)
    test_load_time, test_push_time, test_time, total_test_time = test(model, device, test_loader, criterion)
    scheduler.step()
